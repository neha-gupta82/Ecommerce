...
<body>
    <div id="outer">
        ...
        <ul class="dropdown-menu bg-dark">
            ...
            <li><a href="adminlogout.php" style="z-index: 9999;">Logout</a></li></li>
    ...
    <li  class="dropdown"><a href=""><i class="bi bi-gift"></i><span>Products</span></a>
                    ...
                    <li  class="dropdown"><a href=""><i class="bi bi-person"></i><span>Admin</span></a>
                        <ul class="dropdown-menu bg-dark">
                            <li><a href="#">Change Password</a></li>
                            <li><a href="adminlogout.php">Logout</a></li></li>
                        </ul>
            ...
            <div id="body" class="container-fluid overflow-y-auto">
                <!-- <div class="menu">  <li  class="dropdown"><a href=""><i class="bi bi-person"></i><span>Admin</span></a>
                        <ul class="dropdown-menu bg-dark">
                            <li><a href="#">Change Password</a></li>
